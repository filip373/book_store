...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference('Librarian.count') do
      post librarians_url, params: { librarian: { last_name: @librarian.last_name, name: @librarian.name } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { last_name: @librarian.last_name, name: @librarian.name } }
