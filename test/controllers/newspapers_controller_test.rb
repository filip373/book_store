...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference('Newspaper.count') do
      post newspapers_url, params: { newspaper: { pages: @newspaper.pages, title: @newspaper.title } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { pages: @newspaper.pages, title: @newspaper.title } }
