...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { address: @library.address, foundation_year: @library.foundation_year } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { address: @library.address, foundation_year: @library.foundation_year } }
